...
export default function Footer() {
    ...
    return (
        <motion.footer
            ...
            className="bg-black pt-20! md:pt-24! pb-12! w-full relative overflow-hidden"
        >
            ...
            <MaxWidthWrapper className="relative z-10">
                    ...
                    <div className="w-full md:w-auto flex justify-center md:justify-end">
                        {footerCols.map((col) => (
                            <motion.div
                                ...
                                viewport={{ once: true }}
                            >
                                <motion.p variants={itemAnim} className="font-display font-bold uppercase tracking-[0.2em] text-white text-base md:text-xl">
                                    {col.title}
                                </motion.p>
                ...
                <motion.div
                    ...
                    className="pt-10! border-t border-ink/10 flex justify-center items-center gap-4"
                >
                    <p className="font-body text-white/60 text-sm md:text-base tracking-wide">
