...
export default function Statement() {
    return (
        <section className="bg-ink py-40 md:py-48 px-6 relative overflow-hidden text-center z-10 w-full">
            ...
            <MaxWidthWrapper>
                <div className="relative z-10 w-full max-w-5xl mx-auto">
                    <motion.h2
                        ...
                        className="font-display font-black uppercase text-5xl sm:text-6xl md:text-8xl text-canvas leading-[0.9] mb-32"
                    >
