        ...
        <section
            ...
            <MaxWidthWrapper className="relative z-10">
                <motion.p
                    ...
                    className="font-display font-semibold! uppercase! tracking-[0.15em]! text-orange! text-sm! mb-4!"
                >
                    The Truth
                </motion.p>
                <motion.h2
                ...
                <motion.p
                    ...
                    className="font-body text-white/70! text-base! md:text-lg! max-w-2xl! mb-14!"
                >
                ...
                >
                    {pillars.map((p) => (
                        ...
                        >
                            ...
                            <h3 className="font-display font-black! uppercase! text-lg! md:text-xl! tracking-tighter! text-white! mb-4!">
                                {p.title}
                            </h3>
                            <p className="font-body text-white/60! text-base! md:text-lg! leading-relaxed! group-hover:text-white! transition-colors! duration-300!">
                                {p.desc}
                            </p>
                        </motion.div>
                    ))}
                ...
                >
                    <p className="font-display font-bold! text-orange/80! hover:text-orange! transition-colors! duration-200! text-base! md:text-lg! tracking-wide!">
                        That changes here. →
                    </p>
                </motion.div>
            </MaxWidthWrapper>
