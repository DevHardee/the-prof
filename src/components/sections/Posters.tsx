            ...
            <MaxWidthWrapper className="relative z-10">
                <div className="flex flex-col items-center text-center mb-16!">
                    ...
                    <motion.p
                        ...
                        className="font-body text-muted text-lg mt-4! max-w-xl"
                    >
                ...
                >
                    {shifts.map((shift) => (
                        <motion.div
                            key={shift.title}
                            variants={item}
                            className="group bg-canvas border border-ink/10 rounded-2xl p-8! flex flex-col gap-3 hover:border-blue/30 hover:-translate-y-1 transition-all duration-300 ease-brand"
                        >
