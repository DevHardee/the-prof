...
export default function Statement() {
    return (
        <section id="pillars" className="bg-ink! py-24! relative! overflow-hidden! z-10! w-full!">
            ...
            <MaxWidthWrapper>
                <div className="relative! z-10! w-full! grid! grid-cols-1! lg:grid-cols-5! gap-12! lg:gap-20! items-start!">
                    {/* Left */}
                    <div className="lg:col-span-2!">
                        ...
                        <motion.p
                            ...
                            className="font-body text-canvas/80! text-base! md:text-lg! leading-relaxed! max-w-md! mb-4!"
                        >
                        ...
                        <motion.p
                            ...
                            className="font-body text-canvas/80! text-base! md:text-lg! leading-relaxed! max-w-md!"
                        >
                    ...
                    <div className="lg:col-span-3!">
                        ...
                        >
                            {profCards.map((card, index) => {
                                const icons = [Eye, Target, ShieldCheck, BrainCircuit];
                                ...
                                return (
                                    <motion.div
                                        ...
                                        className="bg-ink/80! border! border-canvas/10! hover:border-blue! rounded-2xl! p-6! flex! flex-col! gap-3! hover:bg-blue/10! transition-colors! duration-300!"
                                    >
                                        <div className="w-10! h-10! rounded-lg! bg-blue/20! flex! items-center! justify-center! text-blue! flex-shrink-0!">
