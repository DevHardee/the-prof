            ...
            <MaxWidthWrapper className="relative z-10">
                <div className="max-w-4xl mx-auto flex flex-col items-center">
                    ...
                    >
                        <a
                            href="#"
                            className="bg-blue text-white font-display font-bold uppercase tracking-wider px-10! py-4! rounded-full hover:bg-canvas hover:text-ink transition-[background-color,color] duration-300 ease-brand flex items-center gap-2"
                        >
                            Charge Your Brain ⚡
                        </a>
                        <a
                            href="#"
                            className="bg-transparent text-canvas border border-canvas/30 font-display font-bold uppercase tracking-wider px-10! py-4! rounded-full hover:bg-canvas hover:text-ink transition-[background-color,color,border-color] duration-300 ease-brand"
                        >
                            Enter The HQ →
                        </a>
                    </motion.div>
