                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16! items-center">
                    ...
                    <div>
                        ...
                        <motion.p
                            ...
                            className="font-body text-muted text-lg leading-relaxed max-w-md"
                        >
                    ...
                    >
                        {audienceItems.map((item) => (
                            <motion.div
                                ...
                                className="flex items-center gap-4 bg-canvas border border-ink/10 rounded-xl p-5! hover:border-blue/30 transition-colors duration-300"
                            >
