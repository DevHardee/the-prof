                    ...
                    <div className="flex! flex-col! gap-12! relative! z-10! w-full!">
                        ...
                        <div className="grid! grid-cols-1! lg:grid-cols-2! gap-12! lg:gap-16! items-center!">
                            ...
                            >
                                ...
                                <motion.p
                                    variants={item}
                                    className="font-body text-white/70! text-base! md:text-lg! max-w-md! mt-10! leading-relaxed!"
                                >
                        ...
                        >
                            {miniCards.map((card) => (
                                ...
                                >
                                    ...
                                    <p className=" font-display font-bold uppercase! tracking-[0.1em]! text-white! text-lg! md:text-xl! mb-2! group-hover:text-white! transition-colors!">
                                        {card.label}
                                    </p>
                                    <p className="font-body text-canvas/80! text-base! md:text-lg! leading-relaxed! flex-1! group-hover:text-white! transition-colors!">{card.value}</p>
                                </motion.div>
                            ))}
                        </motion.div>
                    </div>
