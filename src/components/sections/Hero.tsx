                ...
                <MaxWidthWrapper>
                    <div className="grid! grid-cols-1! lg:grid-cols-2! gap-20! lg:gap-16! items-center! relative! z-10! w-full!">
                        ...
                        >
                            ...
                            <motion.p
                                variants={item}
                                className="font-body text-ink/70! text-lg! md:text-xl! max-w-md! mt-10! mb-8! leading-relaxed!"
                            >
                        ...
                        >
                            <img src="/assets/posters/Poster -02.jpg" alt="The Prof" className="w-full! h-full! object-cover! rounded-2xl! shadow-2xl!" />
                        </motion.div>
