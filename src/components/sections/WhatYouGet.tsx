            ...
            <MaxWidthWrapper className="relative! z-10!">
                <div className="flex! flex-col! items-center! text-center! mb-16!">
                    ...
                    <motion.p
                        ...
                        className="font-body text-canvas/70! text-base! md:text-lg! mt-4! max-w-xl!"
                    >
                        ...
                        return (
                            ...
                            >
                                ...
                                <div className="flex! flex-col! gap-3!">
                                    ...
                                    <h3 className="font-display font-black! text-white! text-lg! md:text-xl! uppercase! tracking-tighter!">
                                        {shift.title}
                                    </h3>
                                    <div className="w-8! h-[2px]! bg-orange/30! group-hover:w-16! group-hover:bg-orange! transition-all! duration-500! mt-1! mb-2!" />
                                    <p className="font-body text-canvas/70! text-base! md:text-lg! leading-relaxed! group-hover:text-canvas/80! transition-colors!">
                                        {shift.desc}
                                    </p>
                                </div>
