...
//             if (count !== null) {
//                 // Start with a baseline of 65 for social proof and add actual registrations
//                 setRegistrationCount(Math.min(totalSeats, 65 + count));
//             }
//         } catch (err) {
...
//     const isFull = registrationCount >= totalSeats;
...
//                                                 {isFull ? 'Fully Booked' : `${totalSeats - registrationCount} seats left`}
//                                             </span>
//                                         </div>
//                                     </div>
//                                 </div>
...
//                                             You will be notified when the event is about to start. See you at the seminar!
//                                         </p>
//                                     </div>
//                                 ) : (
//                                     <>
...
//                                                 Join the Product Management Standard Seminar. The event time will be sent to you directly — we just need your details.
//                                             </p>
//                                         </div>
